...
public class Board extends JPanel implements ActionListener
{
    ...
    public Board()
    {
        ImageIcon i = new ImageIcon("images/bg.jpg");
            background = i.getImage();
        ImageIcon i2 = new ImageIcon("images/bar.png");
            bar = i2.getImage();
        ImageIcon i3 = new ImageIcon("images/pauseScreen.png");
            pauseScreen = i3.getImage();
        ImageIcon i4 = new ImageIcon("images/ball.png");
            bouncyBall = i4.getImage();
        ImageIcon i5 = new ImageIcon("images/ThreeLivesLeft.png");
            threeLivesLeft = i5.getImage();
        ImageIcon i6 = new ImageIcon("images/TwoLivesLeft.png");
            twoLivesLeft = i6.getImage();
        ImageIcon i7 = new ImageIcon("images/OneLifeLeft.png");
            oneLifeLeft = i7.getImage();
        ImageIcon i8 = new ImageIcon("images/NoLivesLeft.png");
            noLivesLeft = i8.getImage();
        ImageIcon i9 = new ImageIcon("images/GAMEOVER.png");
            gameOver = i9.getImage();
        ImageIcon i10 = new ImageIcon("images/PressEnter.png");
            pressEnter = i10.getImage();
        ImageIcon i11 = new ImageIcon("images/PressSPACE.png");
            startGame = i11.getImage();
        ImageIcon i12 = new ImageIcon("images/HighScore.png");
            highScore = i12.getImage();
        ImageIcon i13 = new ImageIcon("images/redBlock.png");
            redBlock = i13.getImage();
        ImageIcon i14 = new ImageIcon("images/orangeBlock.png");
            orangeBlock = i14.getImage();
        ImageIcon i15 = new ImageIcon("images/yellowBlock.png");
            yellowBlock = i15.getImage();
        ImageIcon i16 = new ImageIcon("images/greenBlock.png");
            greenBlock = i16.getImage();
        ImageIcon i17 = new ImageIcon("images/blueBlock.png");
            blueBlock = i17.getImage();
        ImageIcon i18 = new ImageIcon("images/cyanBlock.png");
            cyanBlock = i18.getImage();
        ImageIcon i19 = new ImageIcon("images/purpleBlock.png");
            purpleBlock = i19.getImage();
        ImageIcon i20 = new ImageIcon("images/LivesRemaining.png");
            ilivesRemaining = i20.getImage();
        ImageIcon i21 = new ImageIcon("images/livesR.png");
            livesR = i21.getImage();
        ImageIcon i22 = new ImageIcon("images/Score.png");
            scoreBoard = i22.getImage();
        ImageIcon i23 = new ImageIcon("images/GamePaused.png");
            gamePause = i23.getImage();
        ImageIcon i24 = new ImageIcon("images/PressR.png");
            gameResume = i24.getImage();
        ImageIcon i25 = new ImageIcon("images/PressN.png");
            gameRestart = i25.getImage();
        ImageIcon i26 = new ImageIcon("images/PressQ.png");
            closeGame = i26.getImage();
        ImageIcon i27 = new ImageIcon("images/topBanner.png");
            topBanner = i27.getImage();
        ImageIcon i28 = new ImageIcon("images/endScore.png");
            endScore = i28.getImage();
        ImageIcon i30 = new ImageIcon("images/YouWon.png");
            youWon = i30.getImage();
        ImageIcon i31 = new ImageIcon("images/title.png");
            title = i31.getImage();
        ImageIcon i32 = new ImageIcon("images/SelectDifficulty.png");
            selectDifficulty = i32.getImage();
        ImageIcon i33 = new ImageIcon("images/PressOne.png");
            easy = i33.getImage();
        ImageIcon i34 = new ImageIcon("images/PressTwo.png");
            medium = i34.getImage();
        ImageIcon i35 = new ImageIcon("images/PressThree.png");
            hard = i35.getImage();
        ImageIcon i36 = new ImageIcon("images/PressFour.png");
            xtreme = i36.getImage();
        ...
        try {
            InputStream fontStream = getClass().getResourceAsStream("fonts/Trigram-Light.ttf");
